...
const SunIcon = memo(function SunIcon(): JSX.Element {
	return (
		<AbstractIcon viewBox="0 0 240 240">
			<path
				d="M120,189.697c-38.492,0-69.696-31.205-69.696-69.697S81.508,50.303,120,50.303c38.494,0,69.699,31.205,69.699,69.697
